...
1. Events -> Rules -> Event Pattern: ServiceName = EC2
2. Event Type: EC2 Instance State-change Notification
3. Specific Instance Ids (or Any Instance depending)
4. Add Target: Lambda Function name
5. Configure Data -> Give Rule Name and Description -> Create Rule
'''
